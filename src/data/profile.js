// Semua konten situs. Ganti nilai di sini — tidak perlu menyentuh komponen.
export const profile = {
  ...
  sosial: [
    ...
    {
      nama: "LinkedIn",
      url: "https://www.linkedin.com/in/agil-febri-pradana/",
    },
    { nama: "Instagram", url: "https://www.instagram.com/gilfp_/" },
    { nama: "TikTok", url: "https://www.tiktok.com/@x7agil_" },
  ],
  skills: [
    {
      grup: "Frontend",
    ...
    {
      grup: "Design & UI/UX",
      items: ["Figma", "Responsive Web Design", "UI/UX Design"],
    },
    { grup: "Additional", items: ["WordPress", "SEO"] },
  ],
  projects: [
    {
      judul: "Proyek Pertama",
      deskripsi:
        "Deskripsi singkat proyek: masalah yang diselesaikan dan peran Anda.",
      tech: ["React", "Node.js"],
      demo: "https://demo.example.com",
      repo: "https://github.com/username/proyek-pertama",
    },
    {
      judul: "Proyek Kedua",
      deskripsi: "Deskripsi singkat proyek kedua.",
      tech: ["Vue", "Laravel"],
      demo: "https://demo.example.com",
      repo: "https://github.com/username/proyek-kedua",
    },
  ],
};
