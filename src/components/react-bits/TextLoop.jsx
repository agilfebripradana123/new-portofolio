...
const TextLoop = ({
  ...
  useEffect(() => {
    ...
    // Diadaptasi: zona hover = elemen induk (banner yang terlihat), bukan
    // kotak internal komponen yang tingginya ter-crop overflow. Pause/resume
    // langsung ke tween supaya tetap benar meski tween dibuat ulang.
    ...
    const syncHover = e => {
      ...
      hovered = inside;
      inside ? tween.pause() : tween.resume();
    };
